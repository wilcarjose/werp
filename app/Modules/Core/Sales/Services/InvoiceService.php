...
class InvoiceService extends BaseService
{
    ...
    protected function makeCreateData($data)
    {
        ...
        $data['price_list_type_id'] = $this->priceListTypeService->getOrCreatePriceList($data['currency_id'], 'sales')->id;
        $data['type'] = Invoice::SALE_TYPE;
    ...
    {
        $stateArray = $entity->getState(Basedoc::PR_STATE, 'sales');
    ...
    {
        $stateArray = $entity->getState(Basedoc::CA_STATE, 'sales');
