...
var app = new Vue({
    ...
    mounted: function mounted() {
        var forge = new __WEBPACK_IMPORTED_MODULE_0__ecommerce__["default"]('horizontal', 'iconized'); // vertical/horizontal - default/iconized
        forge.init();
    }
});
...
Component.options.__file = "resources/assets/js/components/ecommerce/Product.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-576a920e", Component.options)
  } else {
    hotAPI.reload("data-v-576a920e", Component.options)
  }
