<div class="input-field col s12 @if($input->isAdvancedOption()) advanced-option @endif">
    ...
    <input class="validate" type="email" id="{{ $input->getName() }}" name="{{ $input->getName() }}" value="{{ old($input->getName()) ?: $input->getValue() }}" @if($input->isDisabled()) disabled="disabled" style="font-weight: 600; background-color: rgb(251, 251, 251) !important;"  @endif>
