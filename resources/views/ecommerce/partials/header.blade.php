        ...
        <nav class="white z-depth-2">
            ...
            <div class="nav-wrapper">
                ...
                <a class="animated brand-logo hide-on-med-and-down defaultMenu-logo" href="javascript:void(0)">
                    <span class="left" style="color: #2a56c6">{{ config('app.name') }}</span>
                </a>
                ...
                <ul class="right">
                    ...
                    <li>
                        <a class="dropdown-button waves-effect waves-set" href="#" data-beloworigin="true" data-activates="top-nav-userProfile">
                            <img class="circle admin-profile-img-small" src="{{ auth()->user() ? (Auth::user()->pic?Storage::url(Auth::user()->pic):url('/images/square/male_6.jpg')) : '' }}" alt="">
                        </a>
                    </li>
                        ...
                        <li class="collection-item">
                            <div class="admin-profile-content">
                                <img class="circle user-profile-img"
                                    src="{{ auth()->user() ? (Auth::user()->pic?Storage::url(Auth::user()->pic):url('/images/square/male_6.jpg')) : '' }}" alt="">
                                <p class="user-name primary-text">{{ auth()->user() ? (ucwords(Auth::user()->name)) : '' }}</p>
                                <p class="user-designation secondary-text">{{ auth()->user() ? (ucwords(Auth::user()->roles()->first()->name)) : '' }}</p>
            ...
            @if (session('test_bd', false)) 
                <div class="nav-wrapper" style="background-color: orangered; height: 45%;">
                    <span style="float: right;margin-right: 20px; line-height: 2; font-weight: 700;">
                        Esta usando una base de datos de pruebas
                    </span>
                </div>
            @endif
        </nav>
